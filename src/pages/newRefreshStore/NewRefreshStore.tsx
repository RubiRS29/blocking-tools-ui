...
import NewMassDeleteBuilderRow from "./NewRefreshStoreRow";
        ...
        <div className="divide-y divide-gray-300 p-8">
            ...
            <div className={"p-5 flex flex-col gap-10"}>
                ...
                <div className={"grid grid-cols-5 gap-5 "}>
                        ...
                        <div className="flex flex-row gap-5 justify-items-center col-span-2 w-full">
                        ...
                        <div className="flex flex-row gap-5 w-full col-span-2">
                            <div  className="block text-sm font-medium leading-6 text-gray-900 ">
                                Description:
                            </div>
                            <textarea
                                ...
                                name="about"
                                rows={3}
                                className="block h-9 w-full rounded-md border-0 py-1.5 px-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-white-600 sm:text-sm sm:leading-6 outline outline-0"
                                defaultValue={''}
                            />
                        </div>
                ...
                <div className={"grid grid-cols-2 gap-4"}>
                    ...
                    <div className=" overflow-auto h-72" >
                        <table className=" overflow-auto w-full h-80">
                            ...
                            {/*{requestApproval.map( ( approvalRequest: IRequestApproval) =>*/}
                            {/*    <ApprovalRequestRow approvalRequest ={approvalRequest} key={approvalRequest.id}/>*/}
                            {/*)}*/}
                            </tbody>
                        </table>
                ...
                <div className={"flex flex-row gap-3 justify-end"}>
                    ...
                    <ActionButton  title={"Create Request"} icon={<FaPlus strokeWidth={2} className="h-5 w-5" />} color={"bg-green-500"} colorHover={"hover:bg-green-400"} size={"w-56 h9"} />
...
export default  NewRefreshStore;
