                ...
                <div className={"flex flex-row gap-5 "}>
                    <div className="flex flex-col justify-items-center ">
                        ...
                        <div className="flex flex-col gap-2 sm:text-sm sm:leading-6">
                            <Radio id="html" name="type" label="SystemCode, PartType, Catalog and Status" className={"h-3 w-3"} />
                            <Radio id="react" name="type" label="Store, State" defaultChecked  className={"h-3 w-3"}/>
